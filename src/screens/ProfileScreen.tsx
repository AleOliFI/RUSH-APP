    ...
    <div className="w-full max-w-2xl mx-auto px-4 py-3 space-y-5 pb-28">
        ...
        <div className="px-5 pb-5 -mt-16 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-[#A1A1AA] font-telemetry mt-0.5">
              {athlete.handle} • Maratona Sub-3h30 • São Paulo, SP
            </p>
      ...
      <div className="bg-[#1C1C1C] rounded-2xl p-4 border border-[#262626] space-y-3 shadow-md">
        <div className="flex items-center justify-between">
          ...
          <span className="font-telemetry text-xs text-[#22C55E] font-bold">STATUS: ÓTIMO</span>
        </div>
        ...
        <div className="grid grid-cols-3 gap-2.5 text-center">
          <div className="bg-[#101010] p-3 rounded-xl border border-[#262626]">
            ...
            <span className="text-[9px] text-[#22C55E] font-bold">Superior • Top 5%</span>
          </div>
          <div className="bg-[#101010] p-3 rounded-xl border border-[#262626]">
            <span className="text-[10px] text-[#A1A1AA] uppercase block">VFC RMSSD</span>
            <span className="font-headline text-2xl text-[#FF5500] block mt-0.5">74 ms</span>
            <span className="text-[9px] text-[#A1A1AA]">Recuperação Alta</span>
          </div>
          <div className="bg-[#101010] p-3 rounded-xl border border-[#262626]">
            ...
            <span className="font-headline text-2xl text-[#F7F5F3] block mt-0.5">
              {athlete.restingHR} bpm
            </span>
            <span className="text-[9px] text-[#A1A1AA]">Atleta Condicionado</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#1C1C1C] rounded-2xl p-4 border border-[#262626] space-y-3 shadow-md">
        ...
        <div className="grid grid-cols-4 gap-2 text-center font-telemetry">
          <div className="bg-[#101010] p-2.5 rounded-xl border border-[#262626]">
            ...
            <span className="text-[9px] text-[#FF5500]">4:09/km</span>
          </div>
          <div className="bg-[#101010] p-2.5 rounded-xl border border-[#262626]">
            ...
            <span className="text-[9px] text-[#FF5500]">4:19/km</span>
          </div>
          <div className="bg-[#101010] p-2.5 rounded-xl border border-[#22C55E]/40">
            ...
            <span className="text-[9px] text-[#22C55E] font-bold">4:21/km (RP)</span>
          </div>
          <div className="bg-[#101010] p-2.5 rounded-xl border border-[#262626]">
            ...
            <span className="text-[9px] text-[#FF5500]">4:56/km</span>
          </div>
        </div>
      </div>
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-[#A1A1AA]">3 Pares Ativos • Desgaste</span>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-[#A1A1AA]">Polar H10 • Garmin</span>
            </div>
          </div>
          <span className="material-symbols-outlined text-[#A1A1AA] text-[18px]">chevron_right</span>
        </button>
      ...
      <div className="space-y-3 pt-2">
        ...
        {activeTab === 'posts' && (
          <div className="space-y-3">
            <div className="bg-[#1C1C1C] p-4 rounded-2xl border border-[#262626] space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-headline text-base text-[#F7F5F3] uppercase">
                  Meia Maratona 21.10 KM (RP Oficial)
                </span>
                <span className="text-xs font-telemetry text-[#22C55E] font-bold">Hoje, 07:15</span>
              </div>
              <p className="text-xs text-[#A1A1AA]">
                Pace médio 4:21/km na Raia da USP. Z4 sustentada e novo recorde pessoal registrado!
              </p>
            </div>
            <div className="bg-[#1C1C1C] p-4 rounded-2xl border border-[#262626] space-y-2">
              <div className="flex items-center justify-between">
                <span className="font-headline text-base text-[#F7F5F3] uppercase">
                  Tiros 8x400m em Pista
                </span>
                <span className="text-xs font-telemetry text-[#A1A1AA]">Quinta-feira</span>
              </div>
              <p className="text-xs text-[#A1A1AA]">
                Repetições cravadas a 3:52/km com cadência em 186 spm.
              </p>
            </div>
          </div>
        )}
        ...
        {activeTab === 'stats' && (
          <div className="bg-[#1C1C1C] p-4 rounded-2xl border border-[#262626] space-y-3">
            <span className="font-headline text-base text-[#F7F5F3] uppercase block">
              Volume Semanal Acumulado (42.0 km / 58.0 km meta)
            </span>
            <div className="w-full h-3 bg-[#101010] rounded-full overflow-hidden border border-[#262626]">
              <div className="h-full bg-[#FF5500] rounded-full" style={{ width: '72%' }} />
            </div>
            <div className="flex items-center justify-between text-xs text-[#A1A1AA] font-telemetry pt-1">
              <span>Carga Aguda ATL: 1.14 (Ideal)</span>
              <span className="text-[#22C55E] font-bold">Equilíbrio Fisiológico</span>
            </div>
          </div>
        )}
        ...
        {activeTab === 'badges' && (
          <div className="grid grid-cols-3 gap-2 text-center text-xs">
            <div className="bg-[#1C1C1C] p-3 rounded-2xl border border-[#22C55E]/40 space-y-1">
              <span className="text-2xl">🥇</span>
              <span className="font-bold text-[#F7F5F3] block">Sub-3h30 Maratona</span>
              <span className="text-[10px] text-[#22C55E]">Conquistado</span>
            </div>
            <div className="bg-[#1C1C1C] p-3 rounded-2xl border border-[#22C55E]/40 space-y-1">
              <span className="text-2xl">⚡</span>
              <span className="font-bold text-[#F7F5F3] block">1.000 KM no Ano</span>
              <span className="text-[10px] text-[#22C55E]">Conquistado</span>
            </div>
            <div className="bg-[#1C1C1C] p-3 rounded-2xl border border-[#262626] space-y-1 opacity-60">
              <span className="text-2xl">🔒</span>
              <span className="font-bold text-[#A1A1AA] block">Sub-20 nos 5K</span>
              <span className="text-[10px] text-[#737373]">Faltam 45s</span>
            </div>
          </div>
        )}
      </div>
